...
# 91 "car_black_box.c"
    ...
    adc_val = (int)((read_adc(0x04)/(float)10.23));
    ...
    clcd_print(event[i],(0xC0 + (9)));
    clcd_putch(((adc_val/10)+'0'),(0xC0 + (13)));
    clcd_putch(((adc_val%10)+'0'),(0xC0 + (14)));
    ...
    static char arr[5]="";
        ...
        else
        {
           ...
           if(chance>1)
           {
               ...
               clcd_write(0x01, 0);
               clcd_print("ATTEMPT FAILURE",(0x80 + (0)));
               clcd_putch(chance+48,(0xC0 + (0)));
               clcd_print(" ATTEMPT LEFT",(0xC0 + (1)));
               TMR0=6;
               min2_count=0;
               TMR0IE=1;
               while(flag_30sec);
           ...
           else
           {
               ...
               while(flag_2min)
               {
                   if(block_flag)
                   {
                   clcd_putch((block_time/100)+48,(0xC0 + (10)));
                   clcd_putch(((block_time/10)%10)+48,(0xC0 + (11)));
                   clcd_putch((block_time%10)+48,(0xC0 + (12)));
                    clcd_putch('s',(0xC0 + (13)));
                    block_flag=0;
                   }
               }
...
void display_menu(unsigned char sw)
{
    ...
    {
   clcd_print(menu[log],(0x80 + (1)));
   clcd_print(menu[log+1],(0xC0 + (1)));
   if(scroll==0)
   {
     clcd_putch('*',(0x80 + (0)));
     clcd_putch(' ',(0xC0 + (0)));
   ...
   else
   {
    ...
    if ((lng_sw==6 && menu_delay_6++>2000))
    {
        menu_delay_6=0;
        login_flag=0;
    }

   if(lng_sw==0xFF &&menu_delay_6>0 )
   {
       menu_delay_6=0;
     if(scroll==0)
     {
...
void view_log(unsigned char sw)
{
    ...
    clcd_putch((temp/10)+48,(0xC0 + (0)));
    clcd_putch((temp%10)+48,(0xC0 + (1)));
    clcd_putch(':',(0xC0 + (2)));
    temp=read_external_eeprom(add1++);
    clcd_putch((temp/10)+48,(0xC0 + (3)));
    clcd_putch((temp%10)+48,(0xC0 + (4)));
    clcd_putch(':',(0xC0 + (5)));
    temp=read_external_eeprom(add1++);
    clcd_putch((temp/10)+48,(0xC0 + (6)));
    clcd_putch((temp%10)+48,(0xC0 + (7)));
    clcd_putch(' ',(0xC0 + (8)));
    temp=read_external_eeprom(add1++);
    clcd_print(event[temp],(0xC0 + (9)));
    clcd_print("  ",(0xC0 + (11)));
    temp=read_external_eeprom(add1++);
    clcd_putch(((temp/10)+'0'),(0xC0 + (13)));
    clcd_putch(((temp%10)+'0'),(0xC0 + (14)));
...
void change_password(unsigned char sw)
{
    ...
    clcd_print("confirm password",(0x80 + (0)));
    clcd_print("           ", (0xC0 + (4)));
    ...
    {
        lng_sw=read_switches(0);
        clcd_print("password entered",(0x80 + (0)));
        clcd_print("    correctly   ",(0xC0 + (0)));

        if((lng_sw==5 && delay_1++>2000 ))
        {
           ...
           for(unsigned char i=0;i<4;i++)
           {
            ...
            clcd_print(" password saved ",(0x80 + (0)));
    ...
    {
        clcd_print(" doesn't match  ",(0x80 + (0)));
        clcd_print("                ",(0xC0 + (0)));
        flag_5sec=1;
        min2_count=0;
        TMR0=6;
...
void set_time(unsigned char sw)
{
 ...
 write_ds1307(0x00,0x80);
    ...
    clcd_print("        ",(0xC0 + (8)));
     ...
     lng_sw=read_switches(0);
       ...
       clcd_putch(time[2],(0xC0 + (2)));
       clcd_putch(time[3],(0xC0 + (3)));
       clcd_putch(time[4],(0xC0 + (4)));
       clcd_putch(time[5],(0xC0 + (5)));
       ...
       clcd_putch('_',(0xC0 + (7)));
        ...
        {
       clcd_putch(time[6],(0xC0 + (6)));
       clcd_putch(time[7],(0xC0 + (7)));
        }
 ...
 write_ds1307(0x01, dummy );

 dummy = (time[0]-48)<<4 | (time[1]-48);
    write_ds1307(0x02, dummy );
